...
const generateMockConversionLogs = (count: number): ConversionLog[] => {
  ...
  const messages = [
    "Transform Word to markdown by www.markdownai.xyz. It's so great make word to markdown converter.",
    "Converted a detailed Word document quickly!",
    "Amazing tool for converting Word to Markdown. Highly recommended!",
    "Finally found a reliable Word to Markdown converter.",
    "Seamless conversion experience from DOCX files.",
    "Very useful for my workflow, turning Word into editable Markdown.",
    "Efficient and accurate conversion from Word to Markdown.",
    "Perfect for extracting content from DOCX for documentation.",
    "The best online Word to Markdown tool I've used!",
    "Quick and clean results every time for Word.",
    "Saved me hours of manual reformatting from Word.",
    "A fantastic solution for developers working with docs.",
    "Loved how easy it was to convert my Word reports.",
    "Fast and reliable, exceeded my expectations for Word conversion.",
    "The output Markdown from Word is clean and easy to work with."
  ];
  ...
  for (let i = 0; i < recentDaysCount; i++) {
    ...
    logs.push({
      ...
      avatarSeed: `word-seed-${Math.random().toString(36).substring(7)}`,
    });
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto text-balance">
            How to convert word to markdown, Select a file to this Word convert markdown,After 15-90 secs, word to markdown converter will complete it.
          </p>
        </div>
              ...
              <div {...getRootProps()} className="cursor-pointer">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    {isDragActive ? 'Drop your Word file here' : 'Choose a Word file or drag it here'}
                  </h3>

                  <p className="text-gray-600 mb-6">
                    Only Word files are supported for this converter. Max size: 10MB
                  </p>
          ...
          <Card className="frosted-glass">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  {conversion.status === 'uploading' ? 'Uploading Word file...' : 'Converting Word to Markdown...'}
                </h3>
            ...
            <Card className="frosted-glass border-green-200">
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Your Word document has been successfully converted to Markdown
                  </p>
          ...
          <Card className="frosted-glass border-red-200">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  {conversion.error || 'An error occurred while converting your Word file'}
                </p>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            They transformed Word to markdown
          </h2>
          ...
          <div className="space-y-6">
            <Card className="frosted-glass p-6">
              <CardTitle className="text-lg font-semibold mb-2 flex items-center">
                ...
                What is Markdown and why convert Word to it?
              </CardTitle>
              <CardDescription>
                Markdown is a lightweight markup language for creating formatted text using a plain-text editor. Converting Word documents to Markdown allows for easier management of content, version control, and seamless integration with web platforms and static site generators without the overhead of complex word processors.
              </CardDescription>
            </Card>
            <Card className="frosted-glass p-6">
              <CardTitle className="text-lg font-semibold mb-2 flex items-center">
                <HelpCircle className="w-5 h-5 mr-2 text-blue-600" />
                How accurate is the Word to Markdown conversion?
              </CardTitle>
              <CardDescription>
                Our AI-powered converter aims for high accuracy in transforming Word documents, preserving headings, lists, tables, and basic formatting. Complex Word features like smart art or specific text boxes might require manual adjustments in the output Markdown.
              </CardDescription>
            </Card>
            <Card className="frosted-glass p-6">
              <CardTitle className="text-lg font-semibold mb-2 flex items-center">
